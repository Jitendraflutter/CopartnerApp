...
//
//     final copartnersModel = copartnersModelFromJson(jsonString);

import 'dart:convert';

CopartnersModel copartnersModelFromJson(String str) => CopartnersModel.fromJson(json.decode(str));

String copartnersModelToJson(CopartnersModel data) => json.encode(data.toJson());

class CopartnersModel {
  bool? isSuccess;
  List<CopartnerList>? data;
  ...
  factory CopartnersModel.fromJson(Map<String, dynamic> json) => CopartnersModel(
    isSuccess: json["isSuccess"],
    data: json["data"] == null ? [] : List<CopartnerList>.from(json["data"]!.map((x) => CopartnerList.fromJson(x))),
...
class CopartnerList {
  ...
  factory CopartnerList.fromJson(Map<String, dynamic> json) => CopartnerList(
    id: json["id"],
